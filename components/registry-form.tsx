...
import { municipios, storage } from '@/services/bondrota';
import type { Cliente, Destino, Municipio, Parada, RotaInterna } from '@/types/domain';

export type EntityKey = 'destinos' | 'paradas' | 'rotas' | 'horarios' | 'veiculos' | 'motoristas' | 'clientes' | 'vinculos' | 'admins';
export interface RegistryRecord { id: number; [key: string]: unknown }
