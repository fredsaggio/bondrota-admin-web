...
import { PageHeader, ErrorState, LoadingRows, EmptyState } from '@/components/ui';
import { useResource } from '@/lib/use-resource';
import { clientes, motoristas, planejamento, reservas, veiculos, viagens } from '@/services/bondrota';
